...
namespace AppComputer.Controllers
{
    public class ComponentsController : Controller
    {
        ...
        {
            ViewData["ComponentTypeId"] = new SelectList(_context.Set<ComponentType>(), "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,ComponentTypeId")] Component component)
        {
            ...
            ViewData["ComponentTypeId"] = new SelectList(_context.Set<ComponentType>(), "Id", "Name", component.ComponentTypeId);
            return View(component);
        }
